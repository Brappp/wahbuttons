...
namespace WahButtons.UI.Components
{
    public class LayoutManager
    {
        ...
        private void DrawTabbedSettings(ButtonWindow window)
        {
            ...
            // Tab management section with combined labels for tab management and currently editing
            ImGui.BeginGroup();
            {
                ...
                // Add New Tab button next to the label
                ...
                ImGui.SameLine();
                // "Currently Editing:" label next to tab management
            ...
            // Button Assignment section (only appears for Tabbed layout)
            if (window.Config.Layout == Configuration.ButtonLayout.Tabbed)
            {
